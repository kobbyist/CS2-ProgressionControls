    ...
    public sealed class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.Preset)), "Vanilla\nUses the game's original milestone XP without population-based XP. All vanilla XP is retained.\n\nPopulation Heavy\nMakes population growth the main source of milestone XP. New all-time population records award XP, while 25% of vanilla XP is retained.\n\nPopulation Only\nAwards milestone XP only when the city reaches a new all-time population record. Vanilla XP sources are ignored.\n\nCustom\nAppears automatically after you edit an XP rule.\n\nTurn on Show Advanced to customize XP per resident, the projected Megalopolis population target, the vanilla XP multiplier, and population update responsiveness." },
