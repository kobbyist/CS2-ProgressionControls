    ...
    public sealed class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "ProgressionControls.Widget.Title", "Progression Controls" },
                { "ProgressionControls.Widget.CustomActive", "Custom progression active" },
                { "ProgressionControls.Widget.VanillaActive", "Vanilla progression active" },
                { "ProgressionControls.Widget.CurrentPopulation", "Current population" },
                { "ProgressionControls.Widget.HistoricalMaximum", "Population record" },
                { "ProgressionControls.Widget.GrowthStatus", "Growth status" },
                { "ProgressionControls.Widget.AtRecord", "At population record" },
                { "ProgressionControls.Widget.ToResume", "to resume" },
                { "ProgressionControls.Widget.MostRecentAward", "Latest population XP" },
                { "ProgressionControls.Widget.NoAward", "None yet" },
                { "ProgressionControls.Widget.DragLabel", "Drag to move" },
