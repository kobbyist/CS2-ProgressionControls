    ...
    public sealed class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "Kobbyist.ProgressionControls.UI.EffectiveXp", "Effective XP" },
                { "Kobbyist.ProgressionControls.UI.MilestoneQueue", "Milestone queue" },
                { "Kobbyist.ProgressionControls.UI.Claimable", "claimable" },
                { "Kobbyist.ProgressionControls.UI.ClaimPreviousFirst", "Claim previous first" },
